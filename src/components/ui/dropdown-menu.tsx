...
>(({ className, children, checked, indicatorRight = false, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      // apply left padding when indicator is left (default), or right padding when indicatorRight
      indicatorRight ? "pl-2 pr-8" : "pl-8 pr-2",
      className
    )}
    checked={checked}
    {...props}
